...
export const GYM_TEMPLATE_PACKS: TemplatePack[] = [
  {
    ...
    items: [
      ...
      { id: "ppl2", title: "Incline Dumbbell Chest Press", desc: "3 Sets x 10-12 Reps" },
      { id: "ppl3", title: "Dumbbell Lateral Raise", desc: "4 Sets x 12-15 Reps" },
      { id: "ppl4", title: "Tricep Cable Rope Pushdown", desc: "4 Sets x 12-15 Reps" },
    ],
  },
  {
    id: "ppl-pull",
    ...
    items: [
      ...
      { id: "pul2", title: "Seated Cable Row (Close Grip)", desc: "3 Sets x 10-12 Reps" },
      { id: "pul3", title: "EZ-Bar Preacher Curl", desc: "4 Sets x 10-12 Reps" },
  ...
  },
  {
    ...
    tagline: "Squat overload, hamstring hinge & calf development",
    badge: "⚡ Lower Body",
    icon: "🦵",
    items: [
      { id: "leg1", title: "Barbell Back Squat", desc: "4 Sets x 6-8 Reps" },
      { id: "leg2", title: "Romanian Deadlift (Barbell / Dumbbell RDL)", desc: "3 Sets x 8-10 Reps" },
      { id: "leg3", title: "Incline Leg Press", desc: "3 Sets x 12-15 Reps" },
      { id: "leg4", title: "Standing Calf Raises", desc: "4 Sets x 15-20 Reps" },
    ],
  },
  {
    id: "upper-hypertrophy",
    name: "Upper Body Hypertrophy",
    tagline: "Balanced upper torso pressing, pulling & arms",
    badge: "⭐ All-in-One",
    icon: "🦍",
    items: [
      { id: "uph1", title: "Incline Dumbbell Chest Press", desc: "3 Sets x 8-10 Reps" },
      { id: "uph2", title: "Seated Cable Row", desc: "3 Sets x 10-12 Reps" },
      { id: "uph3", title: "Dumbbell Lateral Raise", desc: "4 Sets x 12-15 Reps" },
      { id: "uph4", title: "Dumbbell Alternate Bicep Curl", desc: "3 Sets x 10-12 Reps" },
      { id: "uph5", title: "Tricep Cable Rope Pushdown", desc: "3 Sets x 12-15 Reps" },
    ],
  },
  {
    id: "core-conditioning",
    name: "Core & Abdominals Circuit",
    tagline: "Tight waistline, oblique rotation & deep core stabilization",
    badge: "🔥 Core Burn",
    icon: "🧘",
    items: [
      { id: "cor1", title: "Barbell Roll-Out", desc: "3 Sets x 10-12 Reps" },
      { id: "cor2", title: "Hanging Leg Raise", desc: "3 Sets x 12-15 Reps" },
      { id: "cor3", title: "Cable Woodchoppers", desc: "3 Sets x 15 Reps each side" },
      { id: "cor4", title: "Plank Hold", desc: "3 Sets x 60 Seconds" },
    ],
  },
];
