...
export async function GET(req: Request) {
  try {
    ...
    const docs = await Diet.find(query).sort({ createdAt: 1 });
...
// POST /api/goals/diets - create diet entry
...
// PUT /api/goals/diets - update/toggle diet entry
...
// DELETE /api/goals/diets?id=xxx&userId=yyy
export async function DELETE(req: Request) {
  try {
    ...
    await Diet.deleteOne({ _id: id, userId });
